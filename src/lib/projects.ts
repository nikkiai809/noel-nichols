    ...
    sections: [
      {
        ...
        title: 'Overview',
        body: [
          'Velvet Rouge is a premium nightlife and creative technology brand with a strong digital foundation: brand identity, interactive website, content curation, event discovery, ticketing integration, and community engagement.',
        ],
        variant: 'features',
        features: [
